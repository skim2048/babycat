// Lightweight i18n with localStorage persistence.
// Mirrors babycat-web's composable so users see consistent behavior across
// the two apps: same `locale` key, same `t(key, params)` interpolation,
// same html[lang] sync.
...
export function useLocale() {
  ...
  return { locale, isKorean, setLocale, toggleLocale, t }
}
