...
<template>
  <div class="cp-panel">
    <p v-if="props.forced" class="cp-forced">{{ t('changePassword.forcedNotice') }}</p>
    <div class="cp-form">
    ...
    <div class="cp-actions">
      ...
      <button v-if="!props.forced" class="cp-btn cancel" @click="handleCancel">{{ t('changePassword.action.cancel') }}</button>
    </div>
