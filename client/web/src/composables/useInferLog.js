...
// @claude The session log lists inference reports over time, but the
...
// @claude infer_raw stream, newest first, capped for display. Clearing an
// @claude entry only removes it from this in-memory list — there is no
// @claude server-side counterpart to delete.
// @claude 100 entries: roughly an hour of reports at the analyzer cadence,
// @claude enough to scroll back without growing the DOM unbounded.
const MAX_LOG = 100
