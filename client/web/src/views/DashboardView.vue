...
watch(mustChangePassword, (forced) => {
  if (forced) passwordModalOpen.value = true
}, { immediate: true })
...
function closeModal(e) {
  if (backdropMouseDown && e && e.target === e.currentTarget) {
    ...
    if (!mustChangePassword.value) passwordModalOpen.value = false
    ...
    <div v-if="passwordModalOpen" class="modal-backdrop" @mousedown="onBackdropMouseDown" @click="closeModal">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button v-if="!mustChangePassword" class="modal-close" @click="passwordModalOpen = false">&times;</button>
        </div>
        <div class="modal-body">
          <ChangePasswordPanel :forced="mustChangePassword" @close="passwordModalOpen = false" />
        </div>
      </div>
    </div>
  </Transition>
