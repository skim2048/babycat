...
│   │   ├── composables/   # Composition API (useSSE, useClips, usePtz)
│   │   ├── assets/        # 글로벌 CSS
│   │   ├── App.vue        # 루트 컴포넌트
│   │   └── main.js        # 엔트리포인트
│   ├── index.html
...
| 컨테이너 | 포트 | 역할 |
|---|---|---|
| App | 8080 | GStreamer 파이프라인, VLM 추론, 이벤트 판정, FCM 발송, 내부 API (SSE/MJPEG/PTZ) |
| MediaMTX | 8554/8888 | RTSP/WebRTC 스트리밍 서버 (Branch A 패스스루 + 세그먼트 녹화) |
